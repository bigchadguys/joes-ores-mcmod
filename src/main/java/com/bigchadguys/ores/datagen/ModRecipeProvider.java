...
import com.bigchadguys.ores.datagen.custom.MorphiteSynthesizerRecipeBuilder;
...
public class ModRecipeProvider extends RecipeProvider implements IConditionBuilder {
    ...
    protected static ResourceLocation customRecipeId(String path) {
    ...
    protected void buildRecipes(@NotNull RecipeOutput recipeOutput) {
        ...
        MorphiteSynthesizerRecipeBuilder
                .create(
                        Ingredient.of(ModItems.MUSH.get()),
                        new ItemStack(ModItems.FLORITE_INGOT.get(), 1)
                )
                .save(recipeOutput, "florite_ingot");

        MorphiteSynthesizerRecipeBuilder
                .create(
                        Ingredient.of(ModItems.TECTONIC_SHARD.get()),
                        new ItemStack(ModItems.GEOVAR_INGOT.get(), 1)
                )
                .save(recipeOutput, "geovar_ingot");

        MorphiteSynthesizerRecipeBuilder
                .create(
                        Ingredient.of(ModItems.ECTOPLASM.get()),
                        new ItemStack(ModItems.NECRONIUM_INGOT.get(), 1)
                )
                .save(recipeOutput, "necronium_ingot");

        MorphiteSynthesizerRecipeBuilder
                .create(
                        Ingredient.of(ModItems.PETRIFIED_BARK.get()),
                        new ItemStack(ModItems.PETRAFITE_INGOT.get(), 1)
                )
                .save(recipeOutput, "petrafite_ingot");

        MorphiteSynthesizerRecipeBuilder
                .create(
                        Ingredient.of(ModItems.QUICKSILVER.get()),
                        new ItemStack(ModItems.SWIFTITE_INGOT.get(), 1)
                )
                .save(recipeOutput, "swiftite_ingot");
        ...
        Map<String, OreData> ores = Map.of(
                ...
                "morphite", new OreData(
                        List.of(ModItems.RAW_MORPHITE, ModBlocks.MORPHITE_ORE),
                        ModItems.MORPHITE_INGOT.get(),
                        "morphite_ingot"
                )
        );
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.COMBAT, ModItems.NECRONIUM_SWORD.get())
                .pattern(" C ")
                .pattern(" C ")
                .pattern(" S ")
                .define('C', ModItems.NECRONIUM_INGOT)
                .define('S', Items.STICK)
                .unlockedBy("has_raw_morphite", has(ModItems.RAW_MORPHITE))
                .save(recipeOutput);

        ShapedRecipeBuilder.shaped(RecipeCategory.COMBAT, ModItems.PETRAFITE_AXE.get())
                .pattern("CC ")
                .pattern("CS ")
                .pattern(" S ")
                .define('C', ModItems.PETRAFITE_INGOT)
                .define('S', Items.STICK)
                .unlockedBy("has_raw_morphite", has(ModItems.RAW_MORPHITE))
                .save(recipeOutput);

        ShapedRecipeBuilder.shaped(RecipeCategory.TOOLS, ModItems.GEOVAR_PICKAXE.get())
                .pattern("CCC")
                .pattern(" S ")
                .pattern(" S ")
                .define('C', ModItems.GEOVAR_INGOT)
                .define('S', Items.STICK)
                .unlockedBy("has_raw_morphite", has(ModItems.RAW_MORPHITE))
                .save(recipeOutput);

        ShapedRecipeBuilder.shaped(RecipeCategory.TOOLS, ModItems.SWIFTITE_SHOVEL.get())
                .pattern(" C ")
                .pattern(" S ")
                .pattern(" S ")
                .define('C', ModItems.SWIFTITE_INGOT)
                .define('S', Items.STICK)
                .unlockedBy("has_raw_morphite", has(ModItems.RAW_MORPHITE))
                .save(recipeOutput);

        ShapedRecipeBuilder.shaped(RecipeCategory.TOOLS, ModItems.FLORITE_HOE.get())
                .pattern("CC ")
                .pattern(" S ")
                .pattern(" S ")
                .define('C', ModItems.FLORITE_INGOT)
                .define('S', Items.STICK)
                .unlockedBy("has_raw_morphite", has(ModItems.RAW_MORPHITE))
                .save(recipeOutput);
